...
constexpr int padX =winW/(2*5+1);  //2*(bokstaver+sirkel)+1    // velg x skalering
constexpr int padY = winH/(2*8+1);  //2*(6 runder+2 på toppen)+1    // velg y skalering
constexpr int radCircle = padX/8;    //4**2     // velg sirkel radius
